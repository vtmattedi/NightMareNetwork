...
bool NightMareTCPServer::sendToIP(String msg, String ip)
{
  for (size_t i = 0; i < MAX_CLIENTS; i++)
  {
...
bool NightMareTCPServer::sendToIndex(String msg, byte index)
{
...
NightMareTCPServer::NightMareTCPServer(int port) : _message_callback(NULL), _fast_callback(NULL)
{
...
{
  serverInstance = new NightMareTCPServer(DEFAULT_PORT);
