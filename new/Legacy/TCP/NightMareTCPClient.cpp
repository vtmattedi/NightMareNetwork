...
NightMareTCPClient::NightMareTCPClient() : _message_callback(NULL), _fast_callback(NULL)
{
...
NightMareTCPClient::NightMareTCPClient(String Name) : _message_callback(NULL), _fast_callback(NULL)
{
    if (USE_KEEP_ALIVE_BY_DEFAULT)
    {
        _keepAliveInterval = KEEP_ALIVE_DEFAULT_INTERVAL;
