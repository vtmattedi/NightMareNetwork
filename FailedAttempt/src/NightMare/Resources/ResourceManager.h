...
public:
    ...
    ActionStatus invokeLocalResult(const String& id, const String& arguments, String& result);
    ActionStatus writeLocal(const String& id, const String& requested);
...
private:
    ...
    ActionStatus dispatchAction(ResourceRegistry::Entry& entry, const String& payload,
                                bool localCall = false, String* localResult = nullptr);
